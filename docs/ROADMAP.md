...
| Styl art | **stylized / low-poly** — assety: **Quaternius** ([research](./research/2026-08-07-3d-asset-sources.md)) |
...
| **v0.2** | Osada: 3–5 NPC, potrzeby drewno / woda / jedzenie (ścinanie, studnia, …) | `done` |
| **v0.3** | Fauna w lesie: predators & prey (np. wilk, niedźwiedź / sarna, zając) — chase/flee | `in progress` |
...
| **później** | Zegar dnia/nocy (sun + ambient) | `done` (core) |
...
5. v0.3 fauna → [plans/2026-08-07-v03-fauna-chase-flee.md](./plans/2026-08-07-v03-fauna-chase-flee.md)  
6. Później: game UI → [plans/2026-08-07-game-ui-screens.md](./plans/2026-08-07-game-ui-screens.md)  
7. Później: streaming + save → [plans/2026-08-07-world-streaming-persistence.md](./plans/2026-08-07-world-streaming-persistence.md)  
8. ~~Dzień/noc~~ → [plans/2026-08-07-day-night-clock.md](./plans/2026-08-07-day-night-clock.md)  
9. Review queue: [reviews/to-do--water-quality.md](./reviews/to-do--water-quality.md)  

...
| copper_bucket | miedziane wiadro | — | — | none | procedural (M69 needed) | plan items-player-001 §11; copper, 10 l, holds water or milk; future blacksmith smithing/crafting output — not Kupiec stock yet (unlike wooden_bucket); same deferred fill/drink/milking interactions |

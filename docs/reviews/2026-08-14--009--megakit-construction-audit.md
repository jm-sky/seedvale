...
**Status:** `done`
**Date:** 2026-08-14
**Scope:** audit all 176 GLB in `public/models/settlement/megakit/` and design/implement a `ConstructionCatalog` layer over `AssetIndex` (plan [109](../plans/archive/2026-08-14--109--megakit-construction-catalog.md)).

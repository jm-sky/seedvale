...
```
Zrób review planu `world-003-faster-application-startup.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/world-003-faster-application-startup.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-003-faster-application-startup-implementation-notes.md`

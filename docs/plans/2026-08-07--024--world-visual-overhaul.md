...
- [plans/archive/2026-08-07--006--terrain-worker-pool.md](./archive/2026-08-07--006--terrain-worker-pool.md) — blokuje start (kolejność)
- [plans/archive/2026-08-07--007--world-streaming-persistence.md](./archive/2026-08-07--007--world-streaming-persistence.md) — osobna inicjatywa, nie mylić z góralnym tłem tutaj
- [plans/archive/2026-08-07--028--biome-regions.md](./archive/2026-08-07--028--biome-regions.md) — kontynuacja "więcej roślinności" w stronę makro-obszarów o odrębnym charakterze (pustynia/bagno/las)

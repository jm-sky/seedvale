...
| 14 | NPC social, households & dialogue | households, relationships, memory, social state and dialogue integration | ✅ reviewed | [review](../reviews/codebase-domain-audit/2026-09-19--14--npc-social-households-and-dialogue.md) | [npc-060](./npc-060-social-pairing-cadence-and-allocation.md) |
| 15 | Combat — shared pipeline | player/NPC/fauna damage, threat, death, corpses, rewards and cross-actor symmetry | ⬜ not reviewed | - | - |
| 16 | Fauna ecosystem | spawn/population, habitat, hunger, predation, reproduction, migration and lifecycle | ⚠️ reviewed with unresolved high/critical findings | [review](../reviews/codebase-domain-audit/2026-09-19--16--fauna-ecosystem.md) | [fauna-041](./fauna-041-managed-spawner-population-authority.md), [fauna-042](./fauna-042-fauna-proximity-and-population-scan-cost.md), [fauna-043](./fauna-043-frenzy-source-target-claim-cleanup.md) |
| 17 | Domestic animals & ownership | horses/livestock, ownership/assignment, persistence, following, death/disappearance | ⚠️ reviewed with unresolved high/critical findings | [review](../reviews/codebase-domain-audit/2026-09-19--17--domestic-animals-and-ownership.md) | [settlements-npcs-048](./settlements-npcs-048-merchant-pack-animal-assignment-and-journey-continuity.md) |

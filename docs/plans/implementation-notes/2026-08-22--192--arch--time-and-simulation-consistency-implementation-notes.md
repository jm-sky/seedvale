...
- **`docs/architecture/ARCHITECTURE.md`** — added a short "Time model" section (World Time / Simulation Time / Real-Time Actions, when to use each, pointer to `timeConversion.ts`).

...
> Date: 2026-09-12 05:57:14  

## PLANS

- `fauna-024-lost-livestock-stray-displacement.md`
...
```
Zrób review planu `fauna-024-lost-livestock-stray-displacement.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/fauna-024-lost-livestock-stray-displacement.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/fauna-024-lost-livestock-stray-displacement-implementation-notes.md`

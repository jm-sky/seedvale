...
- `items-player-019-player-camp-repair-and-sewing-kit.md`
...
- `ui-input-010-player-quick-actions-and-primary-weapon-slots.md`
- `world-017-contextual-river-water-safety.md`
...
```
Zrób review planu `items-player-018-camp-inspection-condition-and-full-camp-setup.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/items-player-018-camp-inspection-condition-and-full-camp-setup.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/items-player-018-camp-inspection-condition-and-full-camp-setup-implementation-notes.md`
...
```
Zrób review planu `items-player-019-player-camp-repair-and-sewing-kit.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/items-player-019-player-camp-repair-and-sewing-kit.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/items-player-019-player-camp-repair-and-sewing-kit-implementation-notes.md`
...
```
Zrób review planu `npc-004-npc-genealogy-lineages.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/npc-004-npc-genealogy-lineages.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
```
Zrób review planu `npc-021-endurance-driven-stamina-capacity-and-recovery.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/npc-021-endurance-driven-stamina-capacity-and-recovery.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/npc-021-endurance-driven-stamina-capacity-and-recovery-implementation-notes.md`
...
```
Zrób review planu `npc-022-agility-driven-melee-recovery.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/npc-022-agility-driven-melee-recovery.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/npc-022-agility-driven-melee-recovery-implementation-notes.md`
...
```
Zrób review planu `npc-024-temporary-conditions-and-poisoning.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/npc-024-temporary-conditions-and-poisoning.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
```
Zrób review planu `quests-progression-001-reputation-and-renown-foundation.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-001-reputation-and-renown-foundation.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/quests-progression-001-reputation-and-renown-foundation-implementation-notes.md`
...
```
Zrób review planu `quests-progression-002-quest-outcomes-rewards-and-consequences.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-002-quest-outcomes-rewards-and-consequences.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
```
Zrób review planu `quests-progression-004-quest-availability-and-prerequisites.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-004-quest-availability-and-prerequisites.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
```
Zrób review planu `quests-progression-005-authored-rpg-quests.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-005-authored-rpg-quests.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/quests-progression-005-authored-rpg-quests-implementation-notes.md`
...
```
Zrób review planu `settlements-npcs-023-profession-staffing-and-settlement-composition.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/settlements-npcs-023-profession-staffing-and-settlement-composition.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
```
Zrób review planu `ui-input-010-player-quick-actions-and-primary-weapon-slots.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/ui-input-010-player-quick-actions-and-primary-weapon-slots.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/ui-input-010-player-quick-actions-and-primary-weapon-slots-implementation-notes.md`
...
```
Zrób review planu `world-017-contextual-river-water-safety.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-017-contextual-river-water-safety.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

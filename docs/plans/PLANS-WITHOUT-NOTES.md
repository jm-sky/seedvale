...
> Date: 2026-09-02 23:34:02  

## PLANS

- `persistence-002-save-integrity-guard.md`
...
```
Zrób review planu `persistence-002-save-integrity-guard.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/persistence-002-save-integrity-guard.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/persistence-002-save-integrity-guard-implementation-notes.md`

...
> Date: 2026-09-13 18:40:47  

## PLANS

- `quests-progression-032-nonlinear-stage-objectives-and-transitions.md`
...
```
Zrób review planu `quests-progression-032-nonlinear-stage-objectives-and-transitions.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-032-nonlinear-stage-objectives-and-transitions.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/quests-progression-032-nonlinear-stage-objectives-and-transitions-implementation-notes.md`
...
Po ukończeniu implementation notes zaktualizuj też `docs/plans/quests-progression-032-nonlinear-stage-objectives-and-transitions.md` i dodaj/ustaw metadata:

...
```
Zrób review planu `npc-009-combat-feedback-and-death-consequences.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `/home/runner/work/seedvale/seedvale/docs/plans/npc-009-combat-feedback-and-death-consequences.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

...
- `world-019-persistent-player-built-site-infrastructure.md`
...
```
Zrób review planu `npc-027-spatial-context-and-cave-traversal.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/npc-027-spatial-context-and-cave-traversal.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
```
Zrób review planu `world-018-cave-aware-rich-finite-resource-deposits.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-018-cave-aware-rich-finite-resource-deposits.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-018-cave-aware-rich-finite-resource-deposits-implementation-notes.md`
...
```
Zrób review planu `world-019-persistent-player-built-site-infrastructure.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-019-persistent-player-built-site-infrastructure.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-019-persistent-player-built-site-infrastructure-implementation-notes.md`
...
```
Zrób review planu `world-terrain-016-settlement-cemeteries-and-abandoned-graveyards.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-terrain-016-settlement-cemeteries-and-abandoned-graveyards.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

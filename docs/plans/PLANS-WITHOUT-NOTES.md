...
- `world-024-systemic-treasure-sites-and-keys.md`
...
```
Zrób review planu `world-024-systemic-treasure-sites-and-keys.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-024-systemic-treasure-sites-and-keys.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-024-systemic-treasure-sites-and-keys-implementation-notes.md`

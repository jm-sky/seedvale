...
- `settlements-npcs-037-inter-settlement-goods-transport.md`
...
```
Zrób review planu `quests-progression-039-lost-treasure-chronicles-chronicle-deciphering-and-specialist.md`
...
`docs/plans/implementation-notes/quests-progression-039-lost-treasure-chronicles-chronicle-deciphering-and-specialist-implementation-notes.md`
...
Po ukończeniu implementation notes zaktualizuj też `docs/plans/quests-progression-039-lost-treasure-chronicles-chronicle-deciphering-and-specialist.md` i dodaj/ustaw metadata:
...
```
Zrób review planu `quests-progression-040-lost-treasure-chronicles-dark-forest-estate-alpha-bear-and-treasure-map.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-040-lost-treasure-chronicles-dark-forest-estate-alpha-bear-and-treasure-map.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/quests-progression-040-lost-treasure-chronicles-dark-forest-estate-alpha-bear-and-treasure-map-implementation-notes.md`
...
Po ukończeniu implementation notes zaktualizuj też `docs/plans/quests-progression-040-lost-treasure-chronicles-dark-forest-estate-alpha-bear-and-treasure-map.md` i dodaj/ustaw metadata:
`**Model:** <best>, <cheaper-safe-fallback>`
Wybierz dokładnie dwa modele spośród: Composer, Grok, Sonnet, Opus.
Pierwszy ma być najlepszym wyborem do implementacji, drugi tańszym wariantem o minimalnym dodatkowym ryzyku.
Dobierz modele na podstawie wykonanego reconu i implementation notes, zgodnie z `docs/plans/PLANNING.md`.
...
```
Zrób review planu `quests-progression-042-lost-treasure-chronicles-expedition-remains-journal-and-missing-key-trail.md`
...
Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/quests-progression-042-lost-treasure-chronicles-expedition-remains-journal-and-missing-key-trail-implementation-notes.md`
...
```
Zrób review planu `settlements-npcs-037-inter-settlement-goods-transport.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/settlements-npcs-037-inter-settlement-goods-transport.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
Po ukończeniu implementation notes zaktualizuj też `docs/plans/settlements-npcs-037-inter-settlement-goods-transport.md` i dodaj/ustaw metadata:
`**Model:** <best>, <cheaper-safe-fallback>`
Wybierz dokładnie dwa modele spośród: Composer, Grok, Sonnet, Opus.
Pierwszy ma być najlepszym wyborem do implementacji, drugi tańszym wariantem o minimalnym dodatkowym ryzyku.
Dobierz modele na podstawie wykonanego reconu i implementation notes, zgodnie z `docs/plans/PLANNING.md`.
...
```
Zrób review planu `settlements-npcs-038-travelling-merchant-inter-settlement-role.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/settlements-npcs-038-travelling-merchant-inter-settlement-role.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/settlements-npcs-038-travelling-merchant-inter-settlement-role-implementation-notes.md`
...
Po ukończeniu implementation notes zaktualizuj też `docs/plans/settlements-npcs-038-travelling-merchant-inter-settlement-role.md` i dodaj/ustaw metadata:
`**Model:** <best>, <cheaper-safe-fallback>`
Wybierz dokładnie dwa modele spośród: Composer, Grok, Sonnet, Opus.
Pierwszy ma być najlepszym wyborem do implementacji, drugi tańszym wariantem o minimalnym dodatkowym ryzyku.
Dobierz modele na podstawie wykonanego reconu i implementation notes, zgodnie z `docs/plans/PLANNING.md`.

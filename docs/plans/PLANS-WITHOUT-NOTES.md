...
- `ui-input-005-lodging-navigation-recovery-and-cancellation.md`
...
```
Zrób review planu `items-player-002-food-provenance-freshness-and-storage.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/items-player-002-food-provenance-freshness-and-storage.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/items-player-002-food-provenance-freshness-and-storage-implementation-notes.md`
...
```
Zrób review planu `settlements-npcs-012-physical-storage-inspection.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/settlements-npcs-012-physical-storage-inspection.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/settlements-npcs-012-physical-storage-inspection-implementation-notes.md`
...
```
Zrób review planu `settlements-npcs-013-hierarchical-domain-history.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/settlements-npcs-013-hierarchical-domain-history.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/settlements-npcs-013-hierarchical-domain-history-implementation-notes.md`
...
```
Zrób review planu `ui-input-005-lodging-navigation-recovery-and-cancellation.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/ui-input-005-lodging-navigation-recovery-and-cancellation.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/ui-input-005-lodging-navigation-recovery-and-cancellation-implementation-notes.md`

...
```
Zrób review planu `fauna-022-animal-variants-and-exceptional-dangerous-animals.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/fauna-022-animal-variants-and-exceptional-dangerous-animals.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/fauna-022-animal-variants-and-exceptional-dangerous-animals-implementation-notes.md`

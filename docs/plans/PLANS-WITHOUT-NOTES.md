...
```
Zrób review planu `fauna-012-animal-threat-perception-and-vocalization-responses.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/fauna-012-animal-threat-perception-and-vocalization-responses.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/fauna-012-animal-threat-perception-and-vocalization-responses-implementation-notes.md`

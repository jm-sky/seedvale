...
```
Zrób review planu `npc-019-shared-spea-foundation-and-strength-driven-melee.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/npc-019-shared-spea-foundation-and-strength-driven-melee.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/npc-019-shared-spea-foundation-and-strength-driven-melee-implementation-notes.md`

...
> Date: 2026-09-05 16:18:35  

## PLANS

- `fauna-016-animal-habitats-roaming-water-trips-and-settlement-rats.md`
...
- `world-016-ambient-soundscape-events-and-lake-frogs.md`
- `world-terrain-013-river-drainage-continuity-and-terrain-adaptation.md`
- `world-terrain-014-weather-driven-cloud-variety-and-ground-fog.md`
...
```
Zrób review planu `fauna-016-animal-habitats-roaming-water-trips-and-settlement-rats.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/fauna-016-animal-habitats-roaming-water-trips-and-settlement-rats.md`
- aktualny codebase,
...
```
Zrób review planu `world-016-ambient-soundscape-events-and-lake-frogs.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-016-ambient-soundscape-events-and-lake-frogs.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-016-ambient-soundscape-events-and-lake-frogs-implementation-notes.md`
...
```
Zrób review planu `world-terrain-013-river-drainage-continuity-and-terrain-adaptation.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-terrain-013-river-drainage-continuity-and-terrain-adaptation.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-terrain-013-river-drainage-continuity-and-terrain-adaptation-implementation-notes.md`
...
```
Zrób review planu `world-terrain-014-weather-driven-cloud-variety-and-ground-fog.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-terrain-014-weather-driven-cloud-variety-and-ground-fog.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-terrain-014-weather-driven-cloud-variety-and-ground-fog-implementation-notes.md`

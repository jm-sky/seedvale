...
```
Zrób review planu `quests-progression-016-world-driven-settlement-quest-opportunities.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-016-world-driven-settlement-quest-opportunities.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

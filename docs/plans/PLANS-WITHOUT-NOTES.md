...
> Date: 2026-09-14 23:32:22  

## PLANS

- `quests-progression-035-story-item-inventory-and-cave-location-clarity.md`
...
```
Zrób review planu `quests-progression-035-story-item-inventory-and-cave-location-clarity.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-035-story-item-inventory-and-cave-location-clarity.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/quests-progression-035-story-item-inventory-and-cave-location-clarity-implementation-notes.md`
...
Po ukończeniu implementation notes zaktualizuj też `docs/plans/quests-progression-035-story-item-inventory-and-cave-location-clarity.md` i dodaj/ustaw metadata:

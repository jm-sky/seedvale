...
```
Zrób review planu `world-006-time-weather-and-biome-ambient-soundscape.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/world-006-time-weather-and-biome-ambient-soundscape.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-006-time-weather-and-biome-ambient-soundscape-implementation-notes.md`

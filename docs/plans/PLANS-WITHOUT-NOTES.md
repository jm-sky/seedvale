...
- `settlements-npcs-026-npc-personal-inventory-and-persistent-belongings.md`
...
```
Zrób review planu `settlements-npcs-026-npc-personal-inventory-and-persistent-belongings.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/settlements-npcs-026-npc-personal-inventory-and-persistent-belongings.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/settlements-npcs-026-npc-personal-inventory-and-persistent-belongings-implementation-notes.md`

...
- `world-014-world-location-landmark-lookup-main-thread-freeze.md`
...
```
Zrób review planu `world-014-world-location-landmark-lookup-main-thread-freeze.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-014-world-location-landmark-lookup-main-thread-freeze.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-014-world-location-landmark-lookup-main-thread-freeze-implementation-notes.md`

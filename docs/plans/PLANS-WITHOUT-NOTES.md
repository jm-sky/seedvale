...
- `world-terrain-028-archetype-aware-cave-story-and-loot-anchors.md`
...
```
Zrób review planu `world-terrain-028-archetype-aware-cave-story-and-loot-anchors.md`
...
Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-terrain-028-archetype-aware-cave-story-and-loot-anchors-implementation-notes.md`
...
Po ukończeniu implementation notes zaktualizuj też `docs/plans/world-terrain-028-archetype-aware-cave-story-and-loot-anchors.md` i dodaj/ustaw metadata:
`**Model:** <best>, <cheaper-safe-fallback>`
Wybierz dokładnie dwa modele spośród: Composer, Grok, Sonnet, Opus.
Pierwszy ma być najlepszym wyborem do implementacji, drugi tańszym wariantem o minimalnym dodatkowym ryzyku.
Dobierz modele na podstawie wykonanego reconu i implementation notes, zgodnie z `docs/plans/PLANNING.md`.

...
- `quests-progression-017-rpg-settlement-quest-matrices.md`
...
```
Zrób review planu `quests-progression-015-stable-npc-identity-for-quests.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-015-stable-npc-identity-for-quests.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
```
Zrób review planu `quests-progression-017-rpg-settlement-quest-matrices.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-017-rpg-settlement-quest-matrices.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

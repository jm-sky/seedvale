...
> Date: 2026-09-04 18:44:22  

## PLANS

- `fauna-013-animal-hand-feeding-and-human-affinity.md`
- `items-player-016-books-and-skill-learning.md`
...
- `world-terrain-010-waterways-and-vegetation.md`
...
```
Zrób review planu `fauna-013-animal-hand-feeding-and-human-affinity.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/fauna-013-animal-hand-feeding-and-human-affinity.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/fauna-013-animal-hand-feeding-and-human-affinity-implementation-notes.md`
...
```
Zrób review planu `items-player-016-books-and-skill-learning.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/items-player-016-books-and-skill-learning.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/items-player-016-books-and-skill-learning-implementation-notes.md`
...
```
Zrób review planu `world-013-world-location-catalog-performance-optimization.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-013-world-location-catalog-performance-optimization.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-013-world-location-catalog-performance-optimization-implementation-notes.md`
...
```
Zrób review planu `world-terrain-010-waterways-and-vegetation.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-terrain-010-waterways-and-vegetation.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

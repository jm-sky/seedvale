...
- `npc-016-work-contracts-payment-and-employer-interaction.md`
...
```
Zrób review planu `items-player-012-player-gathering-and-fire-cooking-polish.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `/home/runner/work/seedvale/seedvale/docs/plans/items-player-012-player-gathering-and-fire-cooking-polish.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
```
Zrób review planu `npc-012-weather-reaction-and-shelter.md`
...
```
Zrób review planu `npc-014-work-contracts-foundation-and-physical-posting.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `/home/runner/work/seedvale/seedvale/docs/plans/npc-014-work-contracts-foundation-and-physical-posting.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
```
Zrób review planu `npc-016-work-contracts-payment-and-employer-interaction.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `/home/runner/work/seedvale/seedvale/docs/plans/npc-016-work-contracts-payment-and-employer-interaction.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`/home/runner/work/seedvale/seedvale/docs/plans/implementation-notes/npc-016-work-contracts-payment-and-employer-interaction-implementation-notes.md`

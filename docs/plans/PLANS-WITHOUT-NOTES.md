...
> Date: 2026-09-10 13:16:29  

## PLANS

- `items-player-022-gameplay-interaction-usability-polish.md`
...
```
Zrób review planu `items-player-022-gameplay-interaction-usability-polish.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/items-player-022-gameplay-interaction-usability-polish.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/items-player-022-gameplay-interaction-usability-polish-implementation-notes.md`

...
```
Zrób review planu `items-player-020-player-built-animal-trough-and-water-storage.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/items-player-020-player-built-animal-trough-and-water-storage.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/items-player-020-player-built-animal-trough-and-water-storage-implementation-notes.md`

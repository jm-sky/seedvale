...
- `world-020-world-structure-condition-and-degradation.md`
- `world-021-world-structure-repair-work-foundation.md`
...
```
Zrób review planu `world-020-world-structure-condition-and-degradation.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-020-world-structure-condition-and-degradation.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-020-world-structure-condition-and-degradation-implementation-notes.md`
...
```
Zrób review planu `world-021-world-structure-repair-work-foundation.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-021-world-structure-repair-work-foundation.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-021-world-structure-repair-work-foundation-implementation-notes.md`

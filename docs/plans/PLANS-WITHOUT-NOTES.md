...
- `settlements-006-merchant-sell-pricing-condition-and-social-standing.md`
...
```
Zrób review planu `settlements-006-merchant-sell-pricing-condition-and-social-standing.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/settlements-006-merchant-sell-pricing-condition-and-social-standing.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/settlements-006-merchant-sell-pricing-condition-and-social-standing-implementation-notes.md`

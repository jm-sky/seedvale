...
- `world-terrain-005-distance-based-terrain-detail-lod.md`
...
```
Zrób review planu `items-player-014-rope-pullable-resource-transport.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/items-player-014-rope-pullable-resource-transport.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/items-player-014-rope-pullable-resource-transport-implementation-notes.md`
...
```
Zrób review planu `world-terrain-005-distance-based-terrain-detail-lod.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-terrain-005-distance-based-terrain-detail-lod.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-terrain-005-distance-based-terrain-detail-lod-implementation-notes.md`

...
- `world-012-world-locations-discovery-and-map-navigation.md`
...
```
Zrób review planu `world-012-world-locations-discovery-and-map-navigation.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-012-world-locations-discovery-and-map-navigation.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-012-world-locations-discovery-and-map-navigation-implementation-notes.md`

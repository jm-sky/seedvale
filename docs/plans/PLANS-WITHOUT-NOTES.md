...
- `tools-011-plan-metadata-graceful-repair-and-self-healing-synchronization.md`
...
```
Zrób review planu `tools-011-plan-metadata-graceful-repair-and-self-healing-synchronization.md`
...
Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/tools-011-plan-metadata-graceful-repair-and-self-healing-synchronization-implementation-notes.md`

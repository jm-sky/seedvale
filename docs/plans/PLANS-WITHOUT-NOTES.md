...
> Date: 2026-09-14 22:29:09  

## PLANS

- `quests-progression-034-quest-giver-cap-markers-dialogue-and-target-lifecycle.md`
...
```
Zrób review planu `quests-progression-034-quest-giver-cap-markers-dialogue-and-target-lifecycle.md`
...
`docs/plans/implementation-notes/quests-progression-034-quest-giver-cap-markers-dialogue-and-target-lifecycle-implementation-notes.md`
...
Po ukończeniu implementation notes zaktualizuj też `docs/plans/quests-progression-034-quest-giver-cap-markers-dialogue-and-target-lifecycle.md` i dodaj/ustaw metadata:

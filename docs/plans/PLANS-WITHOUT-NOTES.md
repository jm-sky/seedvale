...
- `world-terrain-025-underground-cave-pool.md`
...
```
Zrób review planu `quests-progression-021-guard-rewards-and-evening-settlement-duty.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-021-guard-rewards-and-evening-settlement-duty.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
Po ukończeniu implementation notes zaktualizuj też `docs/plans/quests-progression-021-guard-rewards-and-evening-settlement-duty.md` i dodaj/ustaw metadata:
`**Model:** <best>, <cheaper-safe-fallback>`
Wybierz dokładnie dwa modele spośród: Composer, Grok, Sonnet, Opus.
Pierwszy ma być najlepszym wyborem do implementacji, drugi tańszym wariantem o minimalnym dodatkowym ryzyku.
Dobierz modele na podstawie wykonanego reconu i implementation notes, zgodnie z `docs/plans/PLANNING.md`.
...
```
Zrób review planu `quests-progression-022-lazy-social-news-propagation-and-reputation-catch-up.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-022-lazy-social-news-propagation-and-reputation-catch-up.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/quests-progression-022-lazy-social-news-propagation-and-reputation-catch-up-implementation-notes.md`
...
Po ukończeniu implementation notes zaktualizuj też `docs/plans/quests-progression-022-lazy-social-news-propagation-and-reputation-catch-up.md` i dodaj/ustaw metadata:
`**Model:** <best>, <cheaper-safe-fallback>`
Wybierz dokładnie dwa modele spośród: Composer, Grok, Sonnet, Opus.
Pierwszy ma być najlepszym wyborem do implementacji, drugi tańszym wariantem o minimalnym dodatkowym ryzyku.
Dobierz modele na podstawie wykonanego reconu i implementation notes, zgodnie z `docs/plans/PLANNING.md`.
...
```
Zrób review planu `world-terrain-025-underground-cave-pool.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-terrain-025-underground-cave-pool.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-terrain-025-underground-cave-pool-implementation-notes.md`
...
Po ukończeniu implementation notes zaktualizuj też `docs/plans/world-terrain-025-underground-cave-pool.md` i dodaj/ustaw metadata:
`**Model:** <best>, <cheaper-safe-fallback>`
Wybierz dokładnie dwa modele spośród: Composer, Grok, Sonnet, Opus.
Pierwszy ma być najlepszym wyborem do implementacji, drugi tańszym wariantem o minimalnym dodatkowym ryzyku.
Dobierz modele na podstawie wykonanego reconu i implementation notes, zgodnie z `docs/plans/PLANNING.md`.

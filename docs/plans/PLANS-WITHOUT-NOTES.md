...
- `world-007-hidden-finds-and-reputation-badges.md`
...
```
Zrób review planu `world-007-hidden-finds-and-reputation-badges.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/world-007-hidden-finds-and-reputation-badges.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/world-007-hidden-finds-and-reputation-badges-implementation-notes.md`

...
- `ui-input-009-merchant-item-ownership-and-semantic-item-labels.md`
...
```
Zrób review planu `ui-input-009-merchant-item-ownership-and-semantic-item-labels.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/ui-input-009-merchant-item-ownership-and-semantic-item-labels.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/ui-input-009-merchant-item-ownership-and-semantic-item-labels-implementation-notes.md`

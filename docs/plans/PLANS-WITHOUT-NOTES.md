...
- `ui-input-016-building-placement-construction-ux-coherence.md`
...
```
Zrób review planu `ui-input-016-building-placement-construction-ux-coherence.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/ui-input-016-building-placement-construction-ux-coherence.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/ui-input-016-building-placement-construction-ux-coherence-implementation-notes.md`

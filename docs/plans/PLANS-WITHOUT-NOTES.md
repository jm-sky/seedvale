...
- `quests-progression-013-rat-infestation-nest-and-reproduction.md`
...
- `settlements-npcs-029-animal-corpse-cleanup-and-household-sanitation.md`
- `tools-005-seedvale-character-preparation-panel.md`
- `ui-input-013-character-stats.md`
...
```
Zrób review planu `quests-progression-013-rat-infestation-nest-and-reproduction.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/quests-progression-013-rat-infestation-nest-and-reproduction.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.
...
```
Zrób review planu `settlements-npcs-029-animal-corpse-cleanup-and-household-sanitation.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/settlements-npcs-029-animal-corpse-cleanup-and-household-sanitation.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/settlements-npcs-029-animal-corpse-cleanup-and-household-sanitation-implementation-notes.md`
...
```
Zrób review planu `ui-input-013-character-stats.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/ui-input-013-character-stats.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/ui-input-013-character-stats-implementation-notes.md`

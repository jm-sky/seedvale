...
- `settlements-npcs-024-household-owned-profession-workplaces.md`
...
```
Zrób review planu `settlements-npcs-024-household-owned-profession-workplaces.md`

Wczytaj:
- `docs/STATE.md`
- `docs/plans/PLANNING.md` (Implementation Notes section),
- `docs/plans/settlements-npcs-024-household-owned-profession-workplaces.md`
- aktualny codebase,
- potrzebne zależności i powiązane implementacje.

Na podstawie review utwórz w repo plik:
`docs/plans/implementation-notes/settlements-npcs-024-household-owned-profession-workplaces-implementation-notes.md`

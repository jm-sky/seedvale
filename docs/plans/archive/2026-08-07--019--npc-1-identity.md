...
**Status:** `done` — zakres został scalony i zrealizowany w [planie 022](./2026-08-07--022--npc-character-depth.md); ten plik pozostaje referencją historyczną poza indeksem.

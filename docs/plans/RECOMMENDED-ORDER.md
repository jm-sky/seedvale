...
14. `quests-progression-056` — **Dungeon bandit story-item integrity and recovery**  
  🔴 `M` · **Score:**  49  
   → **unlocks:** 0/0
...
23. `quests-progression-059` — **Settlement Known Deeds & Reputation Badges**  
  🟡 `M` · **Score:**  35  
   → **unlocks:** 0/0
...
36. `fauna-034` — **Wildlife Day/Night Rest and Den Defense**  
  🟡 `M` · **Score:**  19  
   → **unlocks:** 0/0

...
| `2026-08-17--149--shader-program-first-use-hitch.md` | First-use shader/program hitch przy streamingu chunków (frame max / liczba hitchy, nie średni FPS); `compileAsync` tylko w kontrolowanym loading window, bez powrotu do per-chunk/full-scene prewarmu; wstępny | 🔴 | M/L | — |
...
| File | Summary | Pri | Effort | Depends |
|------|---------|-----|--------|---------|
| `2026-08-17--144--water-reflection-gpu-optimization.md` | Redukcja kosztu współdzielonego 128² water mirror. Stage S zaimplementowany (`REFLECTION_DISTANT_LAYER`, outer-ring cull). Real-GPU [review 020](../reviews/2026-08-18--020--water-grass-gpu-benchmark.md): `current` mirror draws 206→197, WATER/FPS płaskie; `water` mirror 30→25, scenariusz lekki. Visual cutoff nie sprawdzony; M/L nieruszone. Techniczna weryfikacja zielona (tsc/test 1000/build) — [implementation notes](./2026-08-17--144--water-reflection-gpu-optimization-implementation-notes.md) | 🟡 | M | ~~143~~ |
...
| `2026-08-17--148--grass-gpu-performance.md` | Grass geometry LOD (S): near/mid/far fin-cluster variants on existing `InstancedMesh` buckets. Techniczna weryfikacja zielona. Headless + real-GPU [review 020](../reviews/2026-08-18--020--water-grass-gpu-benchmark.md): `current` grass triangles −47.0% (8.54M→4.53M), draw calls bez zmian, **FPS/RENDER płaskie na Intel Arc 140V** (58.9→58.2 / 12.7→12.9 ms) — ten sam werdykt co SwiftShader. M/L wstrzymane; visual LOD popping nie sprawdzony — [implementation notes](./2026-08-17--148--grass-gpu-performance-implementation-notes.md) | 🟡 | L | — |
...
| File | Summary |
|------|---------|
| `2026-08-14--118--fauna-stada-i-mlode.md` | Stada deer/stag/boar + luźne króliki; młode pomniejszone, follow matki, dorastanie 600 s. Playtest accepted 2026-08-18 |
| `2026-08-15--120--fauna-probabilistic-perception.md` | Percepcja: falloff dystansu × facing × dzień/noc/las, deterministyczny roll. Playtest accepted 2026-08-18 |
| `2026-08-17--137--animal-habitat-and-carcass-visuals.md` | `[E] Zniszcz` kanał 5 s, spalony cave/thicket, czarna ziemia, ogień ~5 min; po harvestcie pozostałości ~90 s. Playtest accepted 2026-08-18 |
| `2026-08-17--138--harvested-remains-glb.md` | Po harvestcie GLB `bones_pile` + kości + skóra + skrawki mięsa. Playtest accepted 2026-08-18 |
| `2026-08-17--139--fauna-day-scale-respawn.md` | Respawn cave/thicket w dniach świata (jeleń 1/dzień, stag 1/2 dni), catch-up przy skipie. Playtest accepted 2026-08-18 |

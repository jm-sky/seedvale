...
| 💡 `fauna-030-player-owned-animal-stay-safety-and-recovery.md`                 | 🔴 | M      | ~~fauna-020~~, ~~fauna-015~~, ~~fauna-029~~                                                                                                                                     | horse-and-riding                        |
| 💡 `quests-progression-036-one-shot-authored-treasure-map-pickup.md`           | 🔴 | S      | ~~quests-progression-008~~, ~~quests-progression-009~~                                                                                                                          | -                                       |
...
| 💡 `ui-input-020-world-interaction-targeting-and-acquisition-feedback-regressions.md` | 🔴 | M      | ~~ui-input-014~~, ~~ui-input-015~~, ~~items-player-024~~                                                                                                                        | -                                       |

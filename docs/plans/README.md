...
| `quests-progression-047-deferred-world-knowledge-and-location-research.md` | Nowy świat: `slad-przy-monolicie` / `old-place-secret` / chronicle-search ruins nie wskazują miejsca przed rozmową; akceptacja → NPC prosi o godzinę; powrót wcześniej = „jeszcze szukam”; po czasie = konkretny kierunek; tylko wskazany landmark zalicza; save w trakcie researchu kontynuuje; natychmiastowe questy lokalizacji bez zmian |

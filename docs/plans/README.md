...
| [2026-08-07--003--day-night-clock.md](./2026-08-07--003--day-night-clock.md) | Zegar dnia/nocy + time multiplier | `verification needed` 🔍 (5/5 — NPC sen zależny od pory + persystencja `timeOfDay` w save zaimplementowane) |
...
| [2026-08-08--043--player-inventory-equipment.md](./2026-08-08--043--player-inventory-equipment.md) | Ekwipunek gracza v1: dedykowany ekran, waga, akcje, zbieranie + nóż/krzesiwo/koc; zarys equipment, durability i craftingu na przyszłość | `verification needed` 🔍 (1-11/11 — Użyj/Połącz z §6 świadomie pominięte, brak jeszcze aktywnego narzędzia/craftingu do podpięcia) |

...
| `2026-08-13--093--quests-v3-world-problems-reputation.md` | Questy z problemów świata + reputacja (nr 059 z 12.08; nie mylić z SFX 059); Etap A–E (relation levels, availability, effects, `animalId`, questy "groźny wilk" + "wilcza jama" end-to-end, lekki `wolfDen` na bazie `PreySpawner`) zaimplementowane i przetestowane, bez weryfikacji w przeglądarce; Etap F+ (livestock `ownerHouseId`, landmark objectives, bandyci) otwarte | 🔴 | XL | ~~015~~ ~~018~~ |
...
| File | Summary | Pri | Effort | Depends |
|------|---------|-----|--------|---------|
| `2026-08-14--109--megakit-construction-catalog.md` | Audyt 176 MegaKit GLB + Construction Catalog nad AssetIndex (fundament pod przyszły HouseBuilder) | 🟡 | L | — |

...
| 💡 `world-terrain-023-river-aware-road-routing-and-crossings.md`               | 🔴 | M      | -                                                                                                                                                                               | -                                       |
...
| 💡 `ui-input-018-player-combat-mode-and-weapon-toggle.md`                      | 🟡 | S      | -                                                                                                                                                                               | -                                       |
| ◼️ `world-terrain-029-persistent-road-route-worldgen-cache.md`                 | 🔴 | M      | world-terrain-023                                                                                                                                                               | -                                       |
| 💡 `world-terrain-032-grass-instancedmesh-constructor-allocation.md`           | 🔴 | S      | -                                                                                                                                                                               | -                                       |
| ◼️ `world-terrain-033-road-bridge-projection-and-traversal.md`                 | 🔴 | M      | world-terrain-023                                                                                                                                                               | -                                       |

...
| File | Summary | Progress | Priority | Effort | Depends on |
|------|---------|----------|----------|--------|------------|
| [2026-08-12--088--asset-alignment-browser.md](./2026-08-12--088--asset-alignment-browser.md) | Dedykowany viewer do wyrównywania assetów, anchorów, oświetlenia i AI diagnostics [has implementation plan] | 0% | 🟡 medium | XL | — |

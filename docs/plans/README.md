...
| `2026-08-08--040--seasons-weather.md` | Pory roku i pogoda — Etap 1 (sezon/pogoda jako efekt wizualny/audio: `world/weather.ts`, `weatherVisuals.ts`, `weatherParticles.ts`, `audio/weatherSounds.ts`, save v14) zaimplementowany, techniczna weryfikacja zielona, bez testu w przeglądarce (patrz [implementation notes](./2026-08-08--040--seasons-weather-implementation-notes.md)); Etap 2–5 (AI/zasoby/NPC/ekonomia) otwarte | 🟡 | XL | ~~003~~ ~~028~~ |

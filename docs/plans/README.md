...
| `2026-08-22--202--arch--god-files-responsibility-boundaries.md` | Przeanalizować i — jeśli jest to uzasadnione — podzielić sześć dużych plików według rzeczywistych responsibility boundaries. | 🟡 | M | ~~201~~ |

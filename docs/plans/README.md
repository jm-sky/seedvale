...
| `settlements-npcs-021-remote-production-site-logistics.md`                     | 🔴 | M      | ~~settlements-npcs-018~~, ~~settlements-npcs-019~~, settlements-npcs-020                                                                                                        | physical-goods-transport                |
...
| 💡 `world-023-species-driven-sowing-density-and-yield.md`                      | 🔴 | M      | ~~settlements-npcs-030~~                                                                                                                                                        | agriculture-and-cultivation             |
| ◼️ `settlements-npcs-031-sustainable-seed-recovery-and-replanting.md`          | 🔴 | L      | ~~settlements-npcs-030~~, world-023                                                                                                                                             | agriculture-and-cultivation             |
...
| 💡 `settlements-npcs-033-player-trading-with-any-npc.md`                       | 🔴 | L      | ~~settlements-npcs-014~~                                                                                                                                                        | economy-goods-flow                      |
| 💡 `quests-progression-027-lost-treasure-expedition.md`                        | 🟡 | L      | ~~world-terrain-028~~, ~~fauna-027~~                                                                                                                                            | -                                       |
| 💡 `settlements-008-settlement-progression-around-home.md`                     | 🟡 | S      | -                                                                                                                                                                               | -                                       |

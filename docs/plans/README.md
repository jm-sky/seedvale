...
| `quests-progression-063-healer-injured-resident.md`                            | 🟡 | M      | -                                                                                                                                                                                                                                                                                          | quests-professions-and-world-consequences |
| `quests-progression-064-healer-difficult-case.md`                              | 🟡 | M      | quests-progression-063                                                                                                                                                                                                                                                                     | quests-professions-and-world-consequences |
| `quests-progression-065-blacksmith-missing-tools.md`                           | 🟡 | M      | -                                                                                                                                                                                                                                                                                          | quests-professions-and-world-consequences |
...
| Plan | Sprawdź |
|------|---------|
| `world-terrain-038-shadow-caster-content-budget-v2.md` | Gate A: `?benchmark=settlement-heavy` → skopiuj pełną sekcję `Shadow casters (one-pass estimate):` (draws/tris/meshes/inst per bucket) oraz dla kontekstu `Scene (one-pass estimate):` + Isolation `full` / `no-shadows` (`render=… ms`). Bez tego nie wybieramy produkcyjnej redukcji contentu. |

...
| `tools-015-chatterbox-local-voice-generation-pipeline.md`                      | 🔴 | M      | ~~npc-041~~, ~~npc-042~~                                                                                                                                                                                                                                                                   | -                                         |
...
| 💡 `quests-progression-049-hunters-brotherhood-hunting-ground-investigation.md` | 🟡 | M      | ~~quests-progression-048~~, ~~fauna-031~~                                                                                                                                                                                                                                                  | quests-hunters-brotherhood                |
...
| `world-terrain-038-shadow-caster-content-budget-v2.md` | Po household-well + garden-plant no-shadow + `WOOD_PILE_MAX_EXTRA` 3→2: `?benchmark=settlement-heavy`. Settlement shadow: `landmarkWellHousehold` ≈ 0; `landmarkGarden` ≈ Dirt-only (dużo mniej tris); overflow max 2 piles. Isolation `full` vs `no-shadows`. Central/pasture wells bez zmian. |
...
| `npc-049-npc-contextual-life-barks-and-local-voice-limiter.md` | Kilka NPC męczy się w pracy → tylko 1–2 `exhausted` w osadzie; głód/pogoda/combat entry dają rzadkie barki; wilk przy stadzie → shepherd `livestock_danger` bez chóru alarmów; denial limitu nie zmienia zachowania; `call_for_help`/`guard_response` jeszcze bez emitów (npc-048) |

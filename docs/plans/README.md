...
| [2026-08-09--048--npc-dialogues-v2.md](./2026-08-09--048--npc-dialogues-v2.md) | Dialogi NPC v2: menu rozmowy (5 tematów) nad istniejącym `dialogue.ts`/needs/schedule/questy/rodzina/wioska — zweryfikowane wobec kodu, zakres v1 przycięty, projekt techniczny gotowy; **zależy od planu 046 Faza 0** (nowe menu budowane w Vue) | `todo` ⬜ |

...
To osobny problem od [planu 087](../plans/2026-08-12--087--vegetation-and-prop-instancing.md) (instancing roślinności/propsów) — 087 explicite wyklucza domy/studnię/tabliczki/palisadę ze swojego zakresu (§2.5: „pojedyncze sztuki per osada, część z raycastem i tintem" → ❌). Instancing by nie pomógł tu wprost; problem to **kiedy** praca się wykonuje (jeden blok synchroniczny), nie ile draw calli.

...
| `public/models/characters/ubc/male_peasant.glb`, `male_ranger.glb` (player) | Universal Base Characters + Modular Character Outfits - Fantasy / Quaternius | [quaternius.com](https://quaternius.com/packs/universalbasecharacters.html) | CC0 1.0 | `Superhero_Male_FullBody` (head slice) + `Hair_SimpleParted` + `Male_Peasant` / `Male_Ranger`; compose script `scripts/assets/compose_ubc_player.py` (plan items-player-033 / 034) |
| `public/models/characters/ubc/male_peasant_brown.webp`, `male_ranger_brown.webp` (player tint) | j.w. | j.w. | CC0 1.0 | Alt BaseColor `T_Peasant_2_BaseColor` / `T_Ranger_3_BaseColor`; runtime `?playerTint=brown` |

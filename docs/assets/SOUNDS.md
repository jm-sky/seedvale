...
| NPC generated | `public/sounds/voices/*` English barks (general / merchant / guard / hunter) + campfire Q/A pairs | Hierarchical resolver `resolveNpcVoiceLine` (plan npc-044); campfire spoken pairs via `campfireTalk` / Social Place pairing (plan npc-045); Super Dialogue remains legacy fallback for greeting / farewell / confirmation |

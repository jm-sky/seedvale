...
| M63 | House interior table | 5 furnished house variants; also the mount anchor origin for M64 | `wired` | plan 169 (`settlement/furniture/table.glb`) |

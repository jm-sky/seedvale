...
| Fauna | wolf, fox, deer, stag, bear, boar (`wild_boar.glb`, M80; `?boarGlb=0` reverts to procedural); livestock chicken/sheep/cow/horse/donkey/dog (Husky+Shiba, see M73); rooster (procedural placeholder, see M72); settlement rats (`rat.glb`, M81) |

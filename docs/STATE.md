...
- Tools in the world: shovel (dig/level soil), axe and battle_axe (multi-stage tree harvest; `isChopTool`), pickaxe (ore + mountain rock), knife and damascus_knife (melee + corpse meat harvest; `isHarvestKnife`), tent (place/rest/pack), garden pitchfork/sickle. High-quality melee (plan 160): damascus knife/short/long, masterwork sword, obsidian sword, battle axe — Kupiec or quest rewards, no world spawn. Starting kit: knife, firestarter, blanket when missing.

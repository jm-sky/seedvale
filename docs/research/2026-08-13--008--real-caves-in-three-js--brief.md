...
1. **Fauna cave spawner** — `src/settlement/props.ts` `createCaveMouth`, `src/fauna/createFauna.ts`.
   Plan [064](docs/plans/archive/2026-08-11--064--cave-spawner-road-avoidance-and-visual.md): skały + etykieta.
   Plan [083](docs/plans/archive/2026-08-12--083--cave-mouth-terrain-depression.md): depresja `modifyTerrain`.
...
2. **Large caves** — `src/world/largeCaves.ts`, `createLargeCaves.ts`, `largeCaveVisual.ts`.
   Plan [090](docs/plans/archive/2026-08-12--090--sword-merchant-tent-caves-pickaxe.md) §4: otwór ~3×3 m, „tunel” 10–15 m, puste, walk-in.

...
| [2026-08-16--011--streaming-hitch-investigation.md](2026-08-16--011--streaming-hitch-investigation.md) | Streaming hitch investigation: Chrome Performance + Perfetto evidence, current shader/GPU synchronization hypothesis, targeted trace awaiting analysis | `in progress` |

...
- `buildHorseAcquisitionQuest` — function — line 1017
- `buildLandmarkQuests` — function — line 924
- `LandmarkResolver` — type — line 913

...
- `isSaveData` — function — line 2057
- `loadSaveData` — function — line 2142
- `loadStoredSave` — function — line 3090
- `migrateStoredSave` — function — line 3053
...
- `StoredSaveResult` — type — line 3079

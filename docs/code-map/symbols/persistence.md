...
- `isSaveData` — function — line 2526
- `loadSaveData` — function — line 2617
- `loadStoredSave` — function — line 3930
- `migrateStoredSave` — function — line 3893
...
- `StoredSaveResult` — type — line 3919

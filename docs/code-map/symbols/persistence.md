...
- `CURRENT_SAVE_VERSION` — const — line 677
- `isSaveData` — function — line 2414
- `loadSaveData` — function — line 2503
- `loadStoredSave` — function — line 3789
- `migrateStoredSave` — function — line 3752
- `SaveBadges` — type — line 185
- `SaveBedroll` — type — line 505
- `SaveCarriedContainer` — type — line 341
- `SaveCart` — type — line 131
- `SaveCompletedTerrainPreparation` — type — line 408
- `SaveConfig` — type — line 53
- `SaveConstructionContractTarget` — type — line 590
- `SaveContractTarget` — type — line 599
- `SaveData` — type — line 689
  - domain: persistence
  - system: save-schema
  - role: Owns the SaveData shape and its validation/defaulting.
  - owns: SaveData
- `SaveDroppedItem` — type — line 93
- `SaveDryingRack` — type — line 289
- `SaveExpeditionDestinationRef` — type — line 623
- `SaveExpeditionEscortContractScope` — type — line 639
- `SaveExpeditionEscortDestination` — type — line 626
- `SaveExpeditionEscortTerms` — type — line 631
- `SaveFishingBait` — type — line 312
- `SaveFoodBatch` — type — line 81
- `SaveGuardClaimState` — type — line 138
- `SaveHive` — type — line 298
- `SaveLocationKnowledge` — type — line 167
- `SaveMap` — type — line 169
- `SaveMeasurableWorkContractScope` — type — line 608
- `SaveMigration` — type — line 2517
- `SavePalisadeContractTarget` — type — line 596
- `SavePalisadeSegment` — type — line 466
- `SavePlacedContainer` — type — line 318
- `SavePlacedFire` — type — line 97
- `SavePlacedTent` — type — line 118
- `SavePlacedTrap` — type — line 247
- `SavePlantedCrop` — type — line 432
- `SavePlantedTree` — type — line 418
- `SavePlatform` — type — line 521
- `SavePlayer` — type — line 61
- `SavePlayerGarden` — type — line 540
- `SavePlayerNeeds` — type — line 228
- `SavePlayerTorch` — type — line 112
- `SavePlayerTrough` — type — line 470
- `SavePlayerWell` — type — line 360
- `SaveQuests` — type — line 75
- `SaveReputation` — type — line 195
- `SaveResidentialBuilding` — type — line 487
- `SaveResidentialBuildingContractTarget` — type — line 598
- `SaveResidentialOwner` — type — line 479
- `SaveSkill` — type — line 239
- `SaveSkills` — type — line 240
- `SaveSocialNews` — type — line 220
- `SaveSocialNewsEvent` — type — line 203
- `SaveSpawnPoint` — type — line 265
- `SaveStandingTorch` — type — line 448
- `SaveStandingTorchContractTarget` — type — line 597
- `SaveTerrainModification` — type — line 383
- `SaveTerrainPreparation` — type — line 394
- `SaveTerrainPreparationContractTarget` — type — line 593
- `SaveTimedProcess` — type — line 279
- `SaveTreasureChestMutation` — type — line 331
- `SaveTreeOverride` — type — line 99
- `SaveWorkContract` — type — line 667
- `SaveWorkContractAdvertisement` — type — line 575
- `SaveWorkContractAssignment` — type — line 576
- `SaveWorkContractAssignmentState` — type — line 565
- `SaveWorkContractScope` — type — line 644
- `SaveWorkContractState` — type — line 557
- `SaveWorldFlags` — type — line 145
- `StoredSaveResult` — type — line 3778

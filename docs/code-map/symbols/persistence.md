...
- `isSaveData` — function — line 2298
- `loadSaveData` — function — line 2384
- `loadStoredSave` — function — line 3576
- `migrateStoredSave` — function — line 3539
...
- `StoredSaveResult` — type — line 3565

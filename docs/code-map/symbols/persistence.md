...
- `isSaveData` — function — line 2716
- `loadSaveData` — function — line 2808
- `loadStoredSave` — function — line 4131
- `migrateStoredSave` — function — line 4094
...
- `StoredSaveResult` — type — line 4120

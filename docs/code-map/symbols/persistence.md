...
- `isSaveData` — function — line 1559
- `loadSaveData` — function — line 1631
- `loadStoredSave` — function — line 2063
- `migrateStoredSave` — function — line 2026
...
- `StoredSaveResult` — type — line 2052

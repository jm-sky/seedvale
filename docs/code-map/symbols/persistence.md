...
- `CURRENT_SAVE_VERSION` — const — line 589
- `isSaveData` — function — line 2025
- `loadSaveData` — function — line 2109
- `loadStoredSave` — function — line 3023
- `migrateStoredSave` — function — line 2986
- `SaveBadges` — type — line 165
- `SaveBedroll` — type — line 459
- `SaveCarriedContainer` — type — line 295
- `SaveCart` — type — line 125
- `SaveCompletedTerrainPreparation` — type — line 362
- `SaveConfig` — type — line 47
- `SaveConstructionContractTarget` — type — line 540
- `SaveContractTarget` — type — line 549
- `SaveData` — type — line 601
  - domain: persistence
  - system: save-schema
  - role: Owns the SaveData shape and its validation/defaulting.
  - owns: SaveData
- `SaveDroppedItem` — type — line 87
- `SaveDryingRack` — type — line 243
- `SaveFishingBait` — type — line 266
- `SaveFoodBatch` — type — line 75
- `SaveHive` — type — line 252
- `SaveLocationKnowledge` — type — line 147
- `SaveMap` — type — line 149
- `SaveMigration` — type — line 2123
- `SavePalisadeContractTarget` — type — line 546
- `SavePalisadeSegment` — type — line 420
- `SavePlacedContainer` — type — line 272
- `SavePlacedFire` — type — line 91
- `SavePlacedTent` — type — line 112
- `SavePlacedTrap` — type — line 201
- `SavePlantedCrop` — type — line 386
- `SavePlantedTree` — type — line 372
- `SavePlatform` — type — line 475
- `SavePlayer` — type — line 55
- `SavePlayerGarden` — type — line 494
- `SavePlayerNeeds` — type — line 182
- `SavePlayerTorch` — type — line 106
- `SavePlayerTrough` — type — line 424
- `SavePlayerWell` — type — line 314
- `SaveQuests` — type — line 69
- `SaveReputation` — type — line 175
- `SaveResidentialBuilding` — type — line 441
- `SaveResidentialBuildingContractTarget` — type — line 548
- `SaveResidentialOwner` — type — line 433
- `SaveSkill` — type — line 193
- `SaveSkills` — type — line 194
- `SaveSpawnPoint` — type — line 219
- `SaveStandingTorch` — type — line 402
- `SaveStandingTorchContractTarget` — type — line 547
- `SaveTerrainModification` — type — line 337
- `SaveTerrainPreparation` — type — line 348
- `SaveTerrainPreparationContractTarget` — type — line 543
- `SaveTimedProcess` — type — line 233
- `SaveTreasureChestMutation` — type — line 285
- `SaveTreeOverride` — type — line 93
- `SaveWorkContract` — type — line 555
- `SaveWorkContractAdvertisement` — type — line 529
- `SaveWorkContractAssignment` — type — line 530
- `SaveWorkContractAssignmentState` — type — line 520
- `SaveWorkContractState` — type — line 512
- `SaveWorldFlags` — type — line 132
- `StoredSaveResult` — type — line 3012

...
- `isSaveData` — function — line 2546
- `loadSaveData` — function — line 2637
- `loadStoredSave` — function — line 3950
- `migrateStoredSave` — function — line 3913
...
- `StoredSaveResult` — type — line 3939

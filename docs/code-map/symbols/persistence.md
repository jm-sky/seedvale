...
- `CURRENT_SAVE_VERSION` — const — line 673
- `isSaveData` — function — line 2299
- `loadSaveData` — function — line 2385
- `loadStoredSave` — function — line 3577
- `migrateStoredSave` — function — line 3540
- `SaveBadges` — type — line 181
- `SaveBedroll` — type — line 501
- `SaveCarriedContainer` — type — line 337
- `SaveCart` — type — line 127
- `SaveCompletedTerrainPreparation` — type — line 404
- `SaveConfig` — type — line 49
- `SaveConstructionContractTarget` — type — line 586
- `SaveContractTarget` — type — line 595
- `SaveData` — type — line 685
  - domain: persistence
  - system: save-schema
  - role: Owns the SaveData shape and its validation/defaulting.
  - owns: SaveData
- `SaveDroppedItem` — type — line 89
- `SaveDryingRack` — type — line 285
- `SaveExpeditionDestinationRef` — type — line 619
- `SaveExpeditionEscortContractScope` — type — line 635
- `SaveExpeditionEscortDestination` — type — line 622
- `SaveExpeditionEscortTerms` — type — line 627
- `SaveFishingBait` — type — line 308
- `SaveFoodBatch` — type — line 77
- `SaveGuardClaimState` — type — line 134
- `SaveHive` — type — line 294
- `SaveLocationKnowledge` — type — line 163
- `SaveMap` — type — line 165
- `SaveMeasurableWorkContractScope` — type — line 604
- `SaveMigration` — type — line 2399
- `SavePalisadeContractTarget` — type — line 592
- `SavePalisadeSegment` — type — line 462
- `SavePlacedContainer` — type — line 314
- `SavePlacedFire` — type — line 93
- `SavePlacedTent` — type — line 114
- `SavePlacedTrap` — type — line 243
- `SavePlantedCrop` — type — line 428
- `SavePlantedTree` — type — line 414
- `SavePlatform` — type — line 517
- `SavePlayer` — type — line 57
- `SavePlayerGarden` — type — line 536
- `SavePlayerNeeds` — type — line 224
- `SavePlayerTorch` — type — line 108
- `SavePlayerTrough` — type — line 466
- `SavePlayerWell` — type — line 356
- `SaveQuests` — type — line 71
- `SaveReputation` — type — line 191
- `SaveResidentialBuilding` — type — line 483
- `SaveResidentialBuildingContractTarget` — type — line 594
- `SaveResidentialOwner` — type — line 475
- `SaveSkill` — type — line 235
- `SaveSkills` — type — line 236
- `SaveSocialNews` — type — line 216
- `SaveSocialNewsEvent` — type — line 199
- `SaveSpawnPoint` — type — line 261
- `SaveStandingTorch` — type — line 444
- `SaveStandingTorchContractTarget` — type — line 593
- `SaveTerrainModification` — type — line 379
- `SaveTerrainPreparation` — type — line 390
- `SaveTerrainPreparationContractTarget` — type — line 589
- `SaveTimedProcess` — type — line 275
- `SaveTreasureChestMutation` — type — line 327
- `SaveTreeOverride` — type — line 95
- `SaveWorkContract` — type — line 663
- `SaveWorkContractAdvertisement` — type — line 571
- `SaveWorkContractAssignment` — type — line 572
- `SaveWorkContractAssignmentState` — type — line 561
- `SaveWorkContractScope` — type — line 640
- `SaveWorkContractState` — type — line 553
- `SaveWorldFlags` — type — line 141
- `StoredSaveResult` — type — line 3566

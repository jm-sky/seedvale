...
- `isSaveData` — function — line 1797
- `loadSaveData` — function — line 1872
- `loadStoredSave` — function — line 2646
- `migrateStoredSave` — function — line 2609
...
- `StoredSaveResult` — type — line 2635

...
- `isSaveData` — function — line 2189
- `loadSaveData` — function — line 2274
- `loadStoredSave` — function — line 3429
- `migrateStoredSave` — function — line 3392
...
- `StoredSaveResult` — type — line 3418

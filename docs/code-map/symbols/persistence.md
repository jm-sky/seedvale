...
- `isSaveData` — function — line 1804
- `loadSaveData` — function — line 1879
- `loadStoredSave` — function — line 2671
- `migrateStoredSave` — function — line 2634
...
- `StoredSaveResult` — type — line 2660

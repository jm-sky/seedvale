...
- `isSaveData` — function — line 2456
- `loadSaveData` — function — line 2545
- `loadStoredSave` — function — line 3831
- `migrateStoredSave` — function — line 3794
...
- `StoredSaveResult` — type — line 3820

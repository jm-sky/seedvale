...
- `isSaveData` — function — line 2482
- `loadSaveData` — function — line 2571
- `loadStoredSave` — function — line 3857
- `migrateStoredSave` — function — line 3820
...
- `StoredSaveResult` — type — line 3846

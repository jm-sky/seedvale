...
- `CURRENT_SAVE_VERSION` — const — line 566
- `isSaveData` — function — line 1862
- `loadSaveData` — function — line 1939
- `loadStoredSave` — function — line 2768
- `migrateStoredSave` — function — line 2731
- `SaveBadges` — type — line 162
- `SaveBedroll` — type — line 436
- `SaveCarriedContainer` — type — line 282
- `SaveCart` — type — line 122
- `SaveCompletedTerrainPreparation` — type — line 349
- `SaveConfig` — type — line 44
- `SaveConstructionContractTarget` — type — line 517
- `SaveContractTarget` — type — line 526
- `SaveData` — type — line 578
  - domain: persistence
  - system: save-schema
  - role: Owns the SaveData shape and its validation/defaulting.
  - owns: SaveData
- `SaveDroppedItem` — type — line 84
- `SaveDryingRack` — type — line 240
- `SaveFishingBait` — type — line 263
- `SaveFoodBatch` — type — line 72
- `SaveHive` — type — line 249
- `SaveLocationKnowledge` — type — line 144
- `SaveMap` — type — line 146
- `SaveMigration` — type — line 1953
- `SavePalisadeContractTarget` — type — line 523
- `SavePalisadeSegment` — type — line 397
- `SavePlacedContainer` — type — line 269
- `SavePlacedFire` — type — line 88
- `SavePlacedTent` — type — line 109
- `SavePlacedTrap` — type — line 198
- `SavePlantedCrop` — type — line 373
- `SavePlantedTree` — type — line 359
- `SavePlatform` — type — line 452
- `SavePlayer` — type — line 52
- `SavePlayerGarden` — type — line 471
- `SavePlayerNeeds` — type — line 179
- `SavePlayerTorch` — type — line 103
- `SavePlayerTrough` — type — line 401
- `SavePlayerWell` — type — line 301
- `SaveQuests` — type — line 66
- `SaveReputation` — type — line 172
- `SaveResidentialBuilding` — type — line 418
- `SaveResidentialBuildingContractTarget` — type — line 525
- `SaveResidentialOwner` — type — line 410
- `SaveSkill` — type — line 190
- `SaveSkills` — type — line 191
- `SaveSpawnPoint` — type — line 216
- `SaveStandingTorch` — type — line 388
- `SaveStandingTorchContractTarget` — type — line 524
- `SaveTerrainModification` — type — line 324
- `SaveTerrainPreparation` — type — line 335
- `SaveTerrainPreparationContractTarget` — type — line 520
- `SaveTimedProcess` — type — line 230
- `SaveTreeOverride` — type — line 90
- `SaveWorkContract` — type — line 532
- `SaveWorkContractAdvertisement` — type — line 506
- `SaveWorkContractAssignment` — type — line 507
- `SaveWorkContractAssignmentState` — type — line 497
- `SaveWorkContractState` — type — line 489
- `SaveWorldFlags` — type — line 129
- `StoredSaveResult` — type — line 2757

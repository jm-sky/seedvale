...
- `isSaveData` — function — line 2010
- `loadSaveData` — function — line 2093
- `loadStoredSave` — function — line 2996
- `migrateStoredSave` — function — line 2959
...
- `StoredSaveResult` — type — line 2985

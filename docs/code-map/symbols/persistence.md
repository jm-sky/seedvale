...
- `CURRENT_SAVE_VERSION` — const — line 675
- `isSaveData` — function — line 2319
- `loadSaveData` — function — line 2405
- `loadStoredSave` — function — line 3605
- `migrateStoredSave` — function — line 3568
- `SaveBadges` — type — line 183
- `SaveBedroll` — type — line 503
- `SaveCarriedContainer` — type — line 339
- `SaveCart` — type — line 129
- `SaveCompletedTerrainPreparation` — type — line 406
- `SaveConfig` — type — line 51
- `SaveConstructionContractTarget` — type — line 588
- `SaveContractTarget` — type — line 597
- `SaveData` — type — line 687
  - domain: persistence
  - system: save-schema
  - role: Owns the SaveData shape and its validation/defaulting.
  - owns: SaveData
- `SaveDroppedItem` — type — line 91
- `SaveDryingRack` — type — line 287
- `SaveExpeditionDestinationRef` — type — line 621
- `SaveExpeditionEscortContractScope` — type — line 637
- `SaveExpeditionEscortDestination` — type — line 624
- `SaveExpeditionEscortTerms` — type — line 629
- `SaveFishingBait` — type — line 310
- `SaveFoodBatch` — type — line 79
- `SaveGuardClaimState` — type — line 136
- `SaveHive` — type — line 296
- `SaveLocationKnowledge` — type — line 165
- `SaveMap` — type — line 167
- `SaveMeasurableWorkContractScope` — type — line 606
- `SaveMigration` — type — line 2419
- `SavePalisadeContractTarget` — type — line 594
- `SavePalisadeSegment` — type — line 464
- `SavePlacedContainer` — type — line 316
- `SavePlacedFire` — type — line 95
- `SavePlacedTent` — type — line 116
- `SavePlacedTrap` — type — line 245
- `SavePlantedCrop` — type — line 430
- `SavePlantedTree` — type — line 416
- `SavePlatform` — type — line 519
- `SavePlayer` — type — line 59
- `SavePlayerGarden` — type — line 538
- `SavePlayerNeeds` — type — line 226
- `SavePlayerTorch` — type — line 110
- `SavePlayerTrough` — type — line 468
- `SavePlayerWell` — type — line 358
- `SaveQuests` — type — line 73
- `SaveReputation` — type — line 193
- `SaveResidentialBuilding` — type — line 485
- `SaveResidentialBuildingContractTarget` — type — line 596
- `SaveResidentialOwner` — type — line 477
- `SaveSkill` — type — line 237
- `SaveSkills` — type — line 238
- `SaveSocialNews` — type — line 218
- `SaveSocialNewsEvent` — type — line 201
- `SaveSpawnPoint` — type — line 263
- `SaveStandingTorch` — type — line 446
- `SaveStandingTorchContractTarget` — type — line 595
- `SaveTerrainModification` — type — line 381
- `SaveTerrainPreparation` — type — line 392
- `SaveTerrainPreparationContractTarget` — type — line 591
- `SaveTimedProcess` — type — line 277
- `SaveTreasureChestMutation` — type — line 329
- `SaveTreeOverride` — type — line 97
- `SaveWorkContract` — type — line 665
- `SaveWorkContractAdvertisement` — type — line 573
- `SaveWorkContractAssignment` — type — line 574
- `SaveWorkContractAssignmentState` — type — line 563
- `SaveWorkContractScope` — type — line 642
- `SaveWorkContractState` — type — line 555
- `SaveWorldFlags` — type — line 143
- `StoredSaveResult` — type — line 3594

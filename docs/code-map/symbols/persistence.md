...
- `isSaveData` — function — line 2402
- `loadSaveData` — function — line 2491
- `loadStoredSave` — function — line 3777
- `migrateStoredSave` — function — line 3740
...
- `StoredSaveResult` — type — line 3766

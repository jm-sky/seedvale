...
- `isSaveData` — function — line 2723
- `loadSaveData` — function — line 2816
- `loadStoredSave` — function — line 4139
- `migrateStoredSave` — function — line 4102
...
- `StoredSaveResult` — type — line 4128

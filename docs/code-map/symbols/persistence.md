...
- `isSaveData` — function — line 2286
- `loadSaveData` — function — line 2372
- `loadStoredSave` — function — line 3564
- `migrateStoredSave` — function — line 3527
...
- `StoredSaveResult` — type — line 3553

...
- `isSaveData` — function — line 2337
- `loadSaveData` — function — line 2424
- `loadStoredSave` — function — line 3692
- `migrateStoredSave` — function — line 3655
- `SaveBadges` — type — line 184
- `SaveBedroll` — type — line 504
- `SaveCarriedContainer` — type — line 340
- `SaveCart` — type — line 130
- `SaveCompletedTerrainPreparation` — type — line 407
- `SaveConfig` — type — line 52
- `SaveConstructionContractTarget` — type — line 589
- `SaveContractTarget` — type — line 598
- `SaveData` — type — line 688
  - domain: persistence
  - system: save-schema
  - role: Owns the SaveData shape and its validation/defaulting.
  - owns: SaveData
- `SaveDroppedItem` — type — line 92
- `SaveDryingRack` — type — line 288
- `SaveExpeditionDestinationRef` — type — line 622
- `SaveExpeditionEscortContractScope` — type — line 638
- `SaveExpeditionEscortDestination` — type — line 625
- `SaveExpeditionEscortTerms` — type — line 630
- `SaveFishingBait` — type — line 311
- `SaveFoodBatch` — type — line 80
- `SaveGuardClaimState` — type — line 137
- `SaveHive` — type — line 297
- `SaveLocationKnowledge` — type — line 166
- `SaveMap` — type — line 168
- `SaveMeasurableWorkContractScope` — type — line 607
- `SaveMigration` — type — line 2438
- `SavePalisadeContractTarget` — type — line 595
- `SavePalisadeSegment` — type — line 465
- `SavePlacedContainer` — type — line 317
- `SavePlacedFire` — type — line 96
- `SavePlacedTent` — type — line 117
- `SavePlacedTrap` — type — line 246
- `SavePlantedCrop` — type — line 431
- `SavePlantedTree` — type — line 417
- `SavePlatform` — type — line 520
- `SavePlayer` — type — line 60
- `SavePlayerGarden` — type — line 539
- `SavePlayerNeeds` — type — line 227
- `SavePlayerTorch` — type — line 111
- `SavePlayerTrough` — type — line 469
- `SavePlayerWell` — type — line 359
- `SaveQuests` — type — line 74
- `SaveReputation` — type — line 194
- `SaveResidentialBuilding` — type — line 486
- `SaveResidentialBuildingContractTarget` — type — line 597
- `SaveResidentialOwner` — type — line 478
- `SaveSkill` — type — line 238
- `SaveSkills` — type — line 239
- `SaveSocialNews` — type — line 219
- `SaveSocialNewsEvent` — type — line 202
- `SaveSpawnPoint` — type — line 264
- `SaveStandingTorch` — type — line 447
- `SaveStandingTorchContractTarget` — type — line 596
- `SaveTerrainModification` — type — line 382
- `SaveTerrainPreparation` — type — line 393
- `SaveTerrainPreparationContractTarget` — type — line 592
- `SaveTimedProcess` — type — line 278
- `SaveTreasureChestMutation` — type — line 330
- `SaveTreeOverride` — type — line 98
- `SaveWorkContract` — type — line 666
- `SaveWorkContractAdvertisement` — type — line 574
- `SaveWorkContractAssignment` — type — line 575
- `SaveWorkContractAssignmentState` — type — line 564
- `SaveWorkContractScope` — type — line 643
- `SaveWorkContractState` — type — line 556
- `SaveWorldFlags` — type — line 144
- `StoredSaveResult` — type — line 3681

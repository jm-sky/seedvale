...
- `isSaveData` — function — line 2326
- `loadSaveData` — function — line 2412
- `loadStoredSave` — function — line 3680
- `migrateStoredSave` — function — line 3643
...
- `StoredSaveResult` — type — line 3669

...
- `CURRENT_SAVE_VERSION` — const — line 659
- `isSaveData` — function — line 2258
- `loadSaveData` — function — line 2344
- `loadStoredSave` — function — line 3536
- `migrateStoredSave` — function — line 3499
- `SaveBadges` — type — line 167
- `SaveBedroll` — type — line 487
- `SaveCarriedContainer` — type — line 323
- `SaveCart` — type — line 127
- `SaveCompletedTerrainPreparation` — type — line 390
- `SaveConfig` — type — line 49
- `SaveConstructionContractTarget` — type — line 572
- `SaveContractTarget` — type — line 581
- `SaveData` — type — line 671
  - domain: persistence
  - system: save-schema
  - role: Owns the SaveData shape and its validation/defaulting.
  - owns: SaveData
- `SaveDroppedItem` — type — line 89
- `SaveDryingRack` — type — line 271
- `SaveExpeditionDestinationRef` — type — line 605
- `SaveExpeditionEscortContractScope` — type — line 621
- `SaveExpeditionEscortDestination` — type — line 608
- `SaveExpeditionEscortTerms` — type — line 613
- `SaveFishingBait` — type — line 294
- `SaveFoodBatch` — type — line 77
- `SaveHive` — type — line 280
- `SaveLocationKnowledge` — type — line 149
- `SaveMap` — type — line 151
- `SaveMeasurableWorkContractScope` — type — line 590
- `SaveMigration` — type — line 2358
- `SavePalisadeContractTarget` — type — line 578
- `SavePalisadeSegment` — type — line 448
- `SavePlacedContainer` — type — line 300
- `SavePlacedFire` — type — line 93
- `SavePlacedTent` — type — line 114
- `SavePlacedTrap` — type — line 229
- `SavePlantedCrop` — type — line 414
- `SavePlantedTree` — type — line 400
- `SavePlatform` — type — line 503
- `SavePlayer` — type — line 57
- `SavePlayerGarden` — type — line 522
- `SavePlayerNeeds` — type — line 210
- `SavePlayerTorch` — type — line 108
- `SavePlayerTrough` — type — line 452
- `SavePlayerWell` — type — line 342
- `SaveQuests` — type — line 71
- `SaveReputation` — type — line 177
- `SaveResidentialBuilding` — type — line 469
- `SaveResidentialBuildingContractTarget` — type — line 580
- `SaveResidentialOwner` — type — line 461
- `SaveSkill` — type — line 221
- `SaveSkills` — type — line 222
- `SaveSocialNews` — type — line 202
- `SaveSocialNewsEvent` — type — line 185
- `SaveSpawnPoint` — type — line 247
- `SaveStandingTorch` — type — line 430
- `SaveStandingTorchContractTarget` — type — line 579
- `SaveTerrainModification` — type — line 365
- `SaveTerrainPreparation` — type — line 376
- `SaveTerrainPreparationContractTarget` — type — line 575
- `SaveTimedProcess` — type — line 261
- `SaveTreasureChestMutation` — type — line 313
- `SaveTreeOverride` — type — line 95
- `SaveWorkContract` — type — line 649
- `SaveWorkContractAdvertisement` — type — line 557
- `SaveWorkContractAssignment` — type — line 558
- `SaveWorkContractAssignmentState` — type — line 547
- `SaveWorkContractScope` — type — line 626
- `SaveWorkContractState` — type — line 539
- `SaveWorldFlags` — type — line 134
- `StoredSaveResult` — type — line 3525

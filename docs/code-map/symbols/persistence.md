...
- `isSaveData` — function — line 2188
- `loadSaveData` — function — line 2273
- `loadStoredSave` — function — line 3428
- `migrateStoredSave` — function — line 3391
...
- `SavePlacedTrap` — type — line 203
- `SavePlantedCrop` — type — line 388
- `SavePlantedTree` — type — line 374
- `SavePlatform` — type — line 477
- `SavePlayer` — type — line 57
- `SavePlayerGarden` — type — line 496
- `SavePlayerNeeds` — type — line 184
- `SavePlayerTorch` — type — line 108
- `SavePlayerTrough` — type — line 426
- `SavePlayerWell` — type — line 316
...
- `StoredSaveResult` — type — line 3417

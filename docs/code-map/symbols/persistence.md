...
- `isSaveData` — function — line 2522
- `loadSaveData` — function — line 2612
- `loadStoredSave` — function — line 3916
- `migrateStoredSave` — function — line 3879
...
- `StoredSaveResult` — type — line 3905

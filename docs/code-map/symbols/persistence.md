...
- `isSaveData` — function — line 2183
- `loadSaveData` — function — line 2268
- `loadStoredSave` — function — line 3451
- `migrateStoredSave` — function — line 3414
...
- `StoredSaveResult` — type — line 3440

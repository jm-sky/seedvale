...
- `isSaveData` — function — line 2028
- `loadSaveData` — function — line 2112
- `loadStoredSave` — function — line 3034
- `migrateStoredSave` — function — line 2997
...
- `StoredSaveResult` — type — line 3023

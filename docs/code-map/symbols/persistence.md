...
- `isSaveData` — function — line 2573
- `loadSaveData` — function — line 2664
- `loadStoredSave` — function — line 3987
- `migrateStoredSave` — function — line 3950
...
- `StoredSaveResult` — type — line 3976

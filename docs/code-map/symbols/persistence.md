...
- `isSaveData` — function — line 2420
- `loadSaveData` — function — line 2509
- `loadStoredSave` — function — line 3795
- `migrateStoredSave` — function — line 3758
...
- `StoredSaveResult` — type — line 3784

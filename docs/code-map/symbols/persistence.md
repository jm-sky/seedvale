...
- `isSaveData` — function — line 1553
- `loadSaveData` — function — line 1625
- `loadStoredSave` — function — line 2032
- `migrateStoredSave` — function — line 1995
...
- `StoredSaveResult` — type — line 2021

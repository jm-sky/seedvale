...
- `isSaveData` — function — line 1955
- `loadSaveData` — function — line 2037
- `loadStoredSave` — function — line 2929
- `migrateStoredSave` — function — line 2892
...
- `StoredSaveResult` — type — line 2918

...
- `CURRENT_SAVE_VERSION` — const — line 683
- `isSaveData` — function — line 2528
- `loadSaveData` — function — line 2619
- `loadStoredSave` — function — line 3932
- `migrateStoredSave` — function — line 3895
- `SaveBadges` — type — line 191
- `SaveBedroll` — type — line 511
- `SaveCarriedContainer` — type — line 347
- `SaveCart` — type — line 134
- `SaveCompletedTerrainPreparation` — type — line 414
- `SaveConfig` — type — line 56
- `SaveConstructionContractTarget` — type — line 596
- `SaveContractTarget` — type — line 605
- `SaveData` — type — line 695
  - domain: persistence
  - system: save-schema
  - role: Owns the SaveData shape and its validation/defaulting.
  - owns: SaveData
- `SaveDroppedItem` — type — line 96
- `SaveDryingRack` — type — line 295
- `SaveExpeditionDestinationRef` — type — line 629
- `SaveExpeditionEscortContractScope` — type — line 645
- `SaveExpeditionEscortDestination` — type — line 632
- `SaveExpeditionEscortTerms` — type — line 637
- `SaveFishingBait` — type — line 318
- `SaveFoodBatch` — type — line 84
- `SaveGuardClaimState` — type — line 141
- `SaveHive` — type — line 304
- `SaveLocationKnowledge` — type — line 170
- `SaveMap` — type — line 172
- `SaveMeasurableWorkContractScope` — type — line 614
- `SaveMigration` — type — line 2633
- `SavePalisadeContractTarget` — type — line 602
- `SavePalisadeSegment` — type — line 472
- `SavePlacedContainer` — type — line 324
- `SavePlacedFire` — type — line 100
- `SavePlacedTent` — type — line 121
- `SavePlacedTrap` — type — line 253
- `SavePlantedCrop` — type — line 438
- `SavePlantedTree` — type — line 424
- `SavePlatform` — type — line 527
- `SavePlayer` — type — line 64
- `SavePlayerGarden` — type — line 546
- `SavePlayerNeeds` — type — line 234
- `SavePlayerTorch` — type — line 115
- `SavePlayerTrough` — type — line 476
- `SavePlayerWell` — type — line 366
- `SaveQuests` — type — line 78
- `SaveReputation` — type — line 201
- `SaveResidentialBuilding` — type — line 493
- `SaveResidentialBuildingContractTarget` — type — line 604
- `SaveResidentialOwner` — type — line 485
- `SaveSkill` — type — line 245
- `SaveSkills` — type — line 246
- `SaveSocialNews` — type — line 226
- `SaveSocialNewsEvent` — type — line 209
- `SaveSpawnPoint` — type — line 271
- `SaveStandingTorch` — type — line 454
- `SaveStandingTorchContractTarget` — type — line 603
- `SaveTerrainModification` — type — line 389
- `SaveTerrainPreparation` — type — line 400
- `SaveTerrainPreparationContractTarget` — type — line 599
- `SaveTimedProcess` — type — line 285
- `SaveTreasureChestMutation` — type — line 337
- `SaveTreeOverride` — type — line 102
- `SaveWorkContract` — type — line 673
- `SaveWorkContractAdvertisement` — type — line 581
- `SaveWorkContractAssignment` — type — line 582
- `SaveWorkContractAssignmentState` — type — line 571
- `SaveWorkContractScope` — type — line 650
- `SaveWorkContractState` — type — line 563
- `SaveWorldFlags` — type — line 148
- `StoredSaveResult` — type — line 3921

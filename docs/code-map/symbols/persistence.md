...
- `isSaveData` — function — line 1927
- `loadSaveData` — function — line 2008
- `loadStoredSave` — function — line 2891
- `migrateStoredSave` — function — line 2854
...
- `StoredSaveResult` — type — line 2880

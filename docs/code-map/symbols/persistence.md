...
- `isSaveData` — function — line 2493
- `loadSaveData` — function — line 2583
- `loadStoredSave` — function — line 3887
- `migrateStoredSave` — function — line 3850
...
- `StoredSaveResult` — type — line 3876

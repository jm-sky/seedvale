...
- `CURRENT_SAVE_VERSION` — const — line 590
- `isSaveData` — function — line 2039
- `loadSaveData` — function — line 2123
- `loadStoredSave` — function — line 3071
- `migrateStoredSave` — function — line 3034
- `SaveBadges` — type — line 166
- `SaveBedroll` — type — line 460
- `SaveCarriedContainer` — type — line 296
- `SaveCart` — type — line 126
- `SaveCompletedTerrainPreparation` — type — line 363
- `SaveConfig` — type — line 48
- `SaveConstructionContractTarget` — type — line 541
- `SaveContractTarget` — type — line 550
- `SaveData` — type — line 602
  - domain: persistence
  - system: save-schema
  - role: Owns the SaveData shape and its validation/defaulting.
  - owns: SaveData
- `SaveDroppedItem` — type — line 88
- `SaveDryingRack` — type — line 244
- `SaveFishingBait` — type — line 267
- `SaveFoodBatch` — type — line 76
- `SaveHive` — type — line 253
- `SaveLocationKnowledge` — type — line 148
- `SaveMap` — type — line 150
- `SaveMigration` — type — line 2137
- `SavePalisadeContractTarget` — type — line 547
- `SavePalisadeSegment` — type — line 421
- `SavePlacedContainer` — type — line 273
- `SavePlacedFire` — type — line 92
- `SavePlacedTent` — type — line 113
- `SavePlacedTrap` — type — line 202
- `SavePlantedCrop` — type — line 387
- `SavePlantedTree` — type — line 373
- `SavePlatform` — type — line 476
- `SavePlayer` — type — line 56
- `SavePlayerGarden` — type — line 495
- `SavePlayerNeeds` — type — line 183
- `SavePlayerTorch` — type — line 107
- `SavePlayerTrough` — type — line 425
- `SavePlayerWell` — type — line 315
- `SaveQuests` — type — line 70
- `SaveReputation` — type — line 176
- `SaveResidentialBuilding` — type — line 442
- `SaveResidentialBuildingContractTarget` — type — line 549
- `SaveResidentialOwner` — type — line 434
- `SaveSkill` — type — line 194
- `SaveSkills` — type — line 195
- `SaveSpawnPoint` — type — line 220
- `SaveStandingTorch` — type — line 403
- `SaveStandingTorchContractTarget` — type — line 548
- `SaveTerrainModification` — type — line 338
- `SaveTerrainPreparation` — type — line 349
- `SaveTerrainPreparationContractTarget` — type — line 544
- `SaveTimedProcess` — type — line 234
- `SaveTreasureChestMutation` — type — line 286
- `SaveTreeOverride` — type — line 94
- `SaveWorkContract` — type — line 556
- `SaveWorkContractAdvertisement` — type — line 530
- `SaveWorkContractAssignment` — type — line 531
- `SaveWorkContractAssignmentState` — type — line 521
- `SaveWorkContractState` — type — line 513
- `SaveWorldFlags` — type — line 133
- `StoredSaveResult` — type — line 3060

...
- `CURRENT_SAVE_VERSION` — const — line 670
- `isSaveData` — function — line 2280
- `loadSaveData` — function — line 2366
- `loadStoredSave` — function — line 3558
- `migrateStoredSave` — function — line 3521
- `SaveBadges` — type — line 178
- `SaveBedroll` — type — line 498
- `SaveCarriedContainer` — type — line 334
- `SaveCart` — type — line 127
- `SaveCompletedTerrainPreparation` — type — line 401
- `SaveConfig` — type — line 49
- `SaveConstructionContractTarget` — type — line 583
- `SaveContractTarget` — type — line 592
- `SaveData` — type — line 682
  - domain: persistence
  - system: save-schema
  - role: Owns the SaveData shape and its validation/defaulting.
  - owns: SaveData
- `SaveDroppedItem` — type — line 89
- `SaveDryingRack` — type — line 282
- `SaveExpeditionDestinationRef` — type — line 616
- `SaveExpeditionEscortContractScope` — type — line 632
- `SaveExpeditionEscortDestination` — type — line 619
- `SaveExpeditionEscortTerms` — type — line 624
- `SaveFishingBait` — type — line 305
- `SaveFoodBatch` — type — line 77
- `SaveGuardClaimState` — type — line 134
- `SaveHive` — type — line 291
- `SaveLocationKnowledge` — type — line 160
- `SaveMap` — type — line 162
- `SaveMeasurableWorkContractScope` — type — line 601
- `SaveMigration` — type — line 2380
- `SavePalisadeContractTarget` — type — line 589
- `SavePalisadeSegment` — type — line 459
- `SavePlacedContainer` — type — line 311
- `SavePlacedFire` — type — line 93
- `SavePlacedTent` — type — line 114
- `SavePlacedTrap` — type — line 240
- `SavePlantedCrop` — type — line 425
- `SavePlantedTree` — type — line 411
- `SavePlatform` — type — line 514
- `SavePlayer` — type — line 57
- `SavePlayerGarden` — type — line 533
- `SavePlayerNeeds` — type — line 221
- `SavePlayerTorch` — type — line 108
- `SavePlayerTrough` — type — line 463
- `SavePlayerWell` — type — line 353
- `SaveQuests` — type — line 71
- `SaveReputation` — type — line 188
- `SaveResidentialBuilding` — type — line 480
- `SaveResidentialBuildingContractTarget` — type — line 591
- `SaveResidentialOwner` — type — line 472
- `SaveSkill` — type — line 232
- `SaveSkills` — type — line 233
- `SaveSocialNews` — type — line 213
- `SaveSocialNewsEvent` — type — line 196
- `SaveSpawnPoint` — type — line 258
- `SaveStandingTorch` — type — line 441
- `SaveStandingTorchContractTarget` — type — line 590
- `SaveTerrainModification` — type — line 376
- `SaveTerrainPreparation` — type — line 387
- `SaveTerrainPreparationContractTarget` — type — line 586
- `SaveTimedProcess` — type — line 272
- `SaveTreasureChestMutation` — type — line 324
- `SaveTreeOverride` — type — line 95
- `SaveWorkContract` — type — line 660
- `SaveWorkContractAdvertisement` — type — line 568
- `SaveWorkContractAssignment` — type — line 569
- `SaveWorkContractAssignmentState` — type — line 558
- `SaveWorkContractScope` — type — line 637
- `SaveWorkContractState` — type — line 550
- `SaveWorldFlags` — type — line 141
- `StoredSaveResult` — type — line 3547

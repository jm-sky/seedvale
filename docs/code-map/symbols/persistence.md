...
- `CURRENT_SAVE_VERSION` — const — line 492
- `isSaveData` — function — line 1603
- `loadSaveData` — function — line 1675
- `loadStoredSave` — function — line 2238
- `migrateStoredSave` — function — line 2201
- `SaveBadges` — type — line 146
- `SaveBedroll` — type — line 381
- `SaveCarriedContainer` — type — line 263
- `SaveCompletedTerrainPreparation` — type — line 327
- `SaveConfig` — type — line 40
- `SaveConstructionContractTarget` — type — line 445
- `SaveContractTarget` — type — line 453
- `SaveData` — type — line 504
  - domain: persistence
  - system: save-schema
  - role: Owns the SaveData shape and its validation/defaulting.
  - owns: SaveData
- `SaveDroppedItem` — type — line 80
- `SaveDryingRack` — type — line 221
- `SaveFishingBait` — type — line 244
- `SaveFoodBatch` — type — line 68
- `SaveHive` — type — line 230
- `SaveLocationKnowledge` — type — line 128
- `SaveMap` — type — line 130
- `SaveMigration` — type — line 1689
- `SavePalisadeContractTarget` — type — line 451
- `SavePalisadeSegment` — type — line 375
- `SavePlacedContainer` — type — line 250
- `SavePlacedFire` — type — line 84
- `SavePlacedTent` — type — line 105
- `SavePlacedTrap` — type — line 183
- `SavePlantedCrop` — type — line 351
- `SavePlantedTree` — type — line 337
- `SavePlatform` — type — line 395
- `SavePlayer` — type — line 48
- `SavePlayerGarden` — type — line 405
- `SavePlayerNeeds` — type — line 164
- `SavePlayerTorch` — type — line 99
- `SavePlayerWell` — type — line 280
- `SaveQuests` — type — line 62
- `SaveReputation` — type — line 157
- `SaveSkill` — type — line 175
- `SaveSkills` — type — line 176
- `SaveSpawnPoint` — type — line 201
- `SaveStandingTorch` — type — line 366
- `SaveStandingTorchContractTarget` — type — line 452
- `SaveTerrainModification` — type — line 302
- `SaveTerrainPreparation` — type — line 313
- `SaveTerrainPreparationContractTarget` — type — line 448
- `SaveTimedProcess` — type — line 211
- `SaveTreeOverride` — type — line 86
- `SaveWorkContract` — type — line 458
- `SaveWorkContractAdvertisement` — type — line 437
- `SaveWorkContractAssignment` — type — line 438
- `SaveWorkContractAssignmentState` — type — line 431
- `SaveWorkContractState` — type — line 423
- `SaveWorldFlags` — type — line 115
- `StoredSaveResult` — type — line 2227

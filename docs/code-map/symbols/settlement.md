...
- `ageMultiplierForAge` — function — line 76
- `clampAge` — function — line 38
- `generatePhysicalProfile` — function — line 143
- `LifeStage` — type — line 13
- `lifeStageForAge` — function — line 42
- `NPC_AGE_MAX` — const — line 11
- `NPC_AGE_MIN` — const — line 10
- `PhysicalProfile` — type — line 120

## `settlement/npcRelationships.ts`

- `createNpcRelationships` — function — line 30
- `NpcRelationships` — type — line 16
...
- `FALLEN_LOG_SPECS` — const — line 52
...
- `WOOD_PILE_HEIGHT` — const — line 87
- `WOOD_PILE_URL` — const — line 85

## `settlement/propUtils.ts`

- `applyTerrainTilt` — function — line 65
- `cloneProp` — function — line 129
- `clonePropWithYaw` — function — line 143
- `loadPropOrFallback` — function — line 105
- `loadPropTemplates` — function — line 120
...
- `createSettlementsManager` — function — line 155
  - domain: settlements

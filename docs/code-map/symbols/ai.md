...
- `modelUrlFor` — function — line 84
- `NPC_CLOTHING_HUE` — const — line 53
- `NPC_MODEL_URLS` — const — line 32
...
- `NPC_UBC_HAIR_1_URL` — const — line 28
- `NPC_UBC_HAIR_2_URL` — const — line 29
- `NPC_UBC_KNIGHT_TINT_URL` — const — line 27

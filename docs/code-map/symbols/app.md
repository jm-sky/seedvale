...
- `WorldBundle` — type — line 385
  ...
  - owns: WorldBundle
  - lifecycle: rebuild
- `WorldStartupLoadingStage` — type — line 1035
- `WorldStartupLoadingStageListener` — type — line 1037

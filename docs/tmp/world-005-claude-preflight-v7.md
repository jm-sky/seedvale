...
- `timeOfDay`
  - src/ai/NpcAgent.ts:1417:  createInspectionSnapshot(timeOfDay: number): NpcInspectionSnapshot {
  - src/ai/NpcAgent.ts:1426:      activity: this.getCurrentActivity(timeOfDay),
  - src/ai/NpcAgent.ts:1469:  why(timeOfDay: number): NpcWhy {
- `DayNightState`

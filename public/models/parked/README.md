...
**not wired** into gameplay yet. A few historical-folder exceptions stay here
after wiring — lily pad (`Lilypad-01.glb`) and the fauna-007 draft cart
(`cart.glb`, MODELS.md M78).

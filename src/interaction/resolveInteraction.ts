...
export function resolveInteraction(
  target: Exclude<Interactable, { kind: 'campfire' | 'item' | 'npc' | 'npcCorpse' | 'dig' | 'corpse' | 'deposit' | 'camp' | 'tent' | 'bedroll' | 'platform' | 'trap' | 'cart' | 'waterEdge' | 'landPlot' | 'dryingRack' | 'hive' | 'crop' | 'container' | 'playerWell' | 'gardenPlot' | 'terrainPreparation' | 'hay' | 'standingTorch' | 'playerTrough' | 'palisade' | 'residentialBuilding' | 'noticeBoard' | 'settlementStorage' | 'ratNest' }>,

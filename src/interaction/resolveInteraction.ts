...
export function resolveInteraction(
  target: Exclude<Interactable, { kind: 'campfire' | 'item' | 'npc' | 'npcCorpse' | 'dig' | 'corpse' | 'deposit' | 'tent' | 'bedroll' | 'platform' | 'trap' | 'waterEdge' | 'landPlot' | 'dryingRack' | 'hive' | 'crop' | 'container' | 'playerWell' | 'gardenPlot' | 'terrainPreparation' | 'hay' | 'standingTorch' | 'playerTrough' | 'palisade' | 'residentialBuilding' | 'noticeBoard' | 'settlementStorage' }>,

...
export const ITEM_GLB_SPECS: Partial<Record<ItemKind, GroundGlbSpec>> = {
  ...
  ring_gold: { url: '/models/items/ring_gold.glb', maxSize: 0.18 },
  ring_turquoise: { url: '/models/items/ring_turquoise.glb', maxSize: 0.18 },
  ring_amethyst: { url: '/models/items/ring_amethyst.glb', maxSize: 0.18 },
  tomato: { url: '/models/items/tomato.glb', maxSize: 0.1 },
  bread: { url: '/models/items/bread.glb', maxSize: 0.28 },
  wooden_bucket: { url: '/models/items/wooden_bucket.glb', maxSize: 0.38 },
  copper_bucket: { url: '/models/items/copper_bucket.glb', maxSize: 0.38 },
  tree_seed: { url: '/models/items/pouch_small.glb', maxSize: 0.22 },
  seed_carrot: { url: '/models/items/pouch_small.glb', maxSize: 0.22 },
  seed_potato: { url: '/models/items/pouch_small.glb', maxSize: 0.22 },
  seed_cabbage: { url: '/models/items/pouch_small.glb', maxSize: 0.22 },

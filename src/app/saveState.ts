...
import type { SocialNewsLedger } from '../reputation/SocialNewsLedger'
...
import type { SaveGuardLocalKnowledgeByNpc } from '../world/locations/guardLocalKnowledge'
...
export type SaveStateDeps = {
  ...
  getGuardLocalKnowledge?: () => SaveGuardLocalKnowledgeByNpc | undefined
...
export function createSaveState(deps: SaveStateDeps): SaveState {
  ...
  const buildSaveData = (): SaveData => {
    ...
    playerTroughs: bundle.playerTroughs.nodes().map((t) => ({ ...t })),

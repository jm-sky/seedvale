...
const CONTROLS: NoteEntry = {
  ...
  body: isTouchDevice()
    ...
    : 'WASD / strzałki — ruch · Shift — bieg · mysz (klik) — rozglądanie · Spacja — skok · E — interakcja · R — interakcja alternatywna · V — sprawdź · T — zejdź z wierzchowca · X — dobyć/schować broń · L — zadania · I — ekwipunek · U — umiejętności · G — upuść · Q — szybkie akcje · M — mapa · Esc — pauza',
}
</script>

...
<template>
  <!-- Deliberately above every other stacking tier (modals z-20/11, busy/
  ...
  <div
    class="pointer-events-none fixed left-1/2 z-50 flex -translate-x-1/2 flex-col items-center gap-1.5"

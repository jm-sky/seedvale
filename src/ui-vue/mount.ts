...
const FORWARDED_FNS = [
  ...
  'configureQuickActions', 'setQuickActionsHasShovel', 'setQuickActionsHasTent', 'setQuickActionsHasCarriedContainer', 'setQuickActionsNearTown', 'setQuickActionsTraps', 'setQuickActionsFireAvailability', 'toggleQuickActions', 'closeQuickActions', 'isQuickActionsOpen',

...
const FORWARDED_FNS = [
  ...
  'configureQuickActions', 'setQuickActionsHasDiggingTool', 'setQuickActionsHasTent', 'setQuickActionsHasCarriedContainer', 'setQuickActionsNearTown', 'setQuickActionsTraps', 'setQuickActionsFireAvailability', 'toggleQuickActions', 'closeQuickActions', 'isQuickActionsOpen',
